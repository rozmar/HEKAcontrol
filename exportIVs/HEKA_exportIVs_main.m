...
%%
                                ...
                                currdifidx=find(max(currdifi~=0,[],2),1,'first');
                                ivnow.current=currdifi(currdifidx,:)';
                                ivnow.segment=[sum(ivnow.segment(1:currdifidx)),ivnow.segment(currdifidx+1:end)];
                                %%
